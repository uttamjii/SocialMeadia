...
exports.deleteMyProfile = async (req, res) => {
    try {
        ...
        // Removing avatar form cloudinary
        await cloudinary.v2.uploader.destroy(user.avatar.public_id);
        ...
        //  revmoving all comments of the userr from all posts
        ...
        // revmoving all likes of the user from all posts
...
exports.resetPasswrod = async (req, res) => {
    try {
